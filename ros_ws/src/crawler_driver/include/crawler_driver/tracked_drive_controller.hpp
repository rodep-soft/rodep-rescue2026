...
public:
     ...
     */
    static double calculateTurnSlipRatio(
        double commanded_angle, double actual_angle) {
     ...
     * @return 推定滑り係数
     */
    static double calculateLinearSlipRatio(
        double commanded_distance, double actual_distance) {
