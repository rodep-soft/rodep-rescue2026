...
#define gt_ggc_m_14bitmap_obstack(X)                \
    do {                                            \
...
#define gt_ggc_m_11value_range(X)                \
    do {                                         \
...
#define gt_ggc_m_38vec_ipcp_transformation_summary_va_gc_(X)                \
    do {                                                                    \
...
#define gt_ggc_m_33function_summary_ipa_fn_summary__(X)                \
    do {                                                               \
...
#define gt_pch_n_14bitmap_obstack(X)                \
    do {                                            \
...
#define gt_pch_n_11value_range(X)                \
    do {                                         \
...
#define gt_pch_n_38vec_ipcp_transformation_summary_va_gc_(X)                \
    do {                                                                    \
...
#define gt_pch_n_33function_summary_ipa_fn_summary__(X)                \
    do {                                                               \
...
extern void gt_pch_p_18vec_gimple__va_gc_(void*, void*, gt_pointer_operator,
                                          void*);
extern void gt_pch_p_11value_range(void*, void*, gt_pointer_operator, void*);
...
extern void gt_pch_p_26vec_size_time_entry_va_gc_(void*, void*,
                                                  gt_pointer_operator, void*);
extern void gt_pch_p_33function_summary_ipa_fn_summary__(void*, void*,
                                                         gt_pointer_operator,
                                                         void*);
