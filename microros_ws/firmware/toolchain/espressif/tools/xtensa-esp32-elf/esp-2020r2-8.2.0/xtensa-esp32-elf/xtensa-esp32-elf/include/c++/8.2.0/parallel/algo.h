...
template <typename _RAIter, typename RandomAccessOutputIterator,
          typename _Predicate>
RandomAccessOutputIterator __unique_copy_switch(
    _RAIter __begin, _RAIter __last, RandomAccessOutputIterator __out,
...
_Output_RAIter __set_difference_switch(
    ...
    if (_GLIBCXX_PARALLEL_CONDITION(
        ...
        return _GLIBCXX_STD_A::set_difference(__begin1, __end1, __begin2,
                                              __end2, __result, __pred);
}
...
_RAIter __adjacent_find_switch(_RAIter __begin, _RAIter __end,
    ...
    if (_GLIBCXX_PARALLEL_CONDITION(true)) {
        _RAIter __spot =
            __gnu_parallel::__find_template(
...
typename iterator_traits<_RAIter>::difference_type __count_switch(
    ...
    if (_GLIBCXX_PARALLEL_CONDITION(
        ...
        __gnu_parallel::__for_each_template_random_access(
            ...
            std::plus<_SequenceIndex>(), __res, __res, -1, __parallelism_tag);
        return __res;
    } else
...
inline _OutputIterator __transform2_switch(_IIter1 __begin1, _IIter1 __end1,
                                           _IIter2 __begin2,
                                           _OutputIterator __result,
                                           _BinaryOperation __binary_op, _Tag1,
                                           _Tag2, _Tag3) {
    return transform(__begin1, __end1, __begin2, __result, __binary_op,
                     __gnu_parallel::sequential_tag());
}
...
void partial_sort(_RAIter __begin, _RAIter __middle, _RAIter __end,
    ...
    if (_GLIBCXX_PARALLEL_CONDITION(
        ...
        __gnu_parallel::__parallel_partial_sort(__begin, __middle, __end,
                                                __comp);
    else
