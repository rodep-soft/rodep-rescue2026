 ...
 * @return End iterator of output sequence.
 */
template <typename UnguardedLoserTree, typename _RAIterIterator,
...
struct __multiway_merge_k_variant_sentinel_switch {
    _RAIter3 operator()(
        ...
        typedef typename std::iterator_traits<
            _RAIterIterator>::value_type::first_type _RAIter1;
        typedef typename std::iterator_traits<_RAIter1>::value_type _ValueType;
...
_RAIter3 __sequential_multiway_merge(
    ...
    switch (__k) {
        ...
        case 1:
            __return_target =
                std::copy(__seqs_begin[0].first,
                          __seqs_begin[0].first + __length, __target);
            __seqs_begin[0].first += __length;
            break;
        case 2:
            __return_target =
                __merge_advance(__seqs_begin[0].first, __seqs_begin[0].second,
        ...
        case 3:
            __return_target = __multiway_merge_3_variant_sentinel_switch<
                ...
                _Compare>()(__seqs_begin, __seqs_end, __target, __length,
                            __comp);
            break;
        case 4:
...
_RAIter3 parallel_multiway_merge(_RAIterIterator __seqs_begin,
    ...
    for (_RAIterIterator __raii = __seqs_begin; __raii != __seqs_end;
         ++__raii) {
...
_RAIterOut multiway_merge_sentinels(_RAIterPairIterator __seqs_begin,
                                    ...
                                    _Compare __comp,
                                    parallel_tag __tag = parallel_tag(0)) {
    return multiway_merge_sentinels(__seqs_begin, __seqs_end, __target,
                                    __length, __comp,
                                    exact_tag(__tag.__get_num_threads()));
}
