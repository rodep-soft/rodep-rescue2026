...
class basic_string {
   ...
   public:
     ...
     *  <code>*this == ""</code>.
     */
    bool empty() const _GLIBCXX_NOEXCEPT { return this->size() == 0; }
    ...
    _If_sv<_Tp, basic_string&> append(const _Tp& __svt, size_type __pos,
        ...
        __sv_type __sv = __svt;
        return _M_append(
            __sv.data() + __sv._M_check(__pos, "basic_string::append"),
    ...
    _If_sv<_Tp, basic_string&> assign(const _Tp& __svt, size_type __pos,
        ...
        return _M_replace(
            size_type(0), this->size(),
            __sv.data() + __sv._M_check(__pos, "basic_string::assign"),
            __sv._M_limit(__pos, __n));
    }
#endif  // C++17
