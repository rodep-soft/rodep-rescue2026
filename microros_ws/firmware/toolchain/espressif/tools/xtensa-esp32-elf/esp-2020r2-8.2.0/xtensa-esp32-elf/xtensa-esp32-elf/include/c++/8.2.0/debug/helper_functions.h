...
template <typename _Iterator>
inline typename _Distance_traits<_Iterator>::__type __get_distance(
    const _Iterator& __lhs, const _Iterator& __rhs, std::input_iterator_tag) {
 ...
 */
template <typename _Integral>
inline bool __valid_range_aux(
    const _Integral&, const _Integral&,
    typename _Distance_traits<_Integral>::__type& __dist, std::__true_type) {
...
template <typename _InputIterator>
inline bool __valid_range(const _InputIterator& __first,
...
template <typename _Iterator>
struct _Siter_base
    : std::_Iter_base<_Iterator,
                      __is_safe_random_iterator<_Iterator>::__value> {};
...
#else
template <typename _Iterator>
inline _Iterator __base(_Iterator __it) {
    return __it;
}
#endif
