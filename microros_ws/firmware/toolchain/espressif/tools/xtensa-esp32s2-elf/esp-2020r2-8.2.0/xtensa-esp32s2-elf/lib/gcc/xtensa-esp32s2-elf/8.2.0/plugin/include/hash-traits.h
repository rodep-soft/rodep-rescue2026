...
template <typename Type>
inline void typed_free_remove<Type>::remove(Type* p) {
    free(p);
}
...
template <typename Type>
inline void typed_noop_remove<Type>::remove(Type&) {}
...
inline hashval_t pointer_hash<Type>::hash(const value_type& candidate) {
    /* This is a really poor hash function, but it is what the current code
       uses, so I am reusing it to avoid an additional axis in testing.  */
...
template <typename Type>
inline void pointer_hash<Type>::mark_empty(Type*& e) {
    e = NULL;
}

template <typename Type>
inline bool pointer_hash<Type>::is_deleted(Type* e) {
    return e == reinterpret_cast<Type*>(1);
}

template <typename Type>
inline bool pointer_hash<Type>::is_empty(Type* e) {
    return e == NULL;
}
