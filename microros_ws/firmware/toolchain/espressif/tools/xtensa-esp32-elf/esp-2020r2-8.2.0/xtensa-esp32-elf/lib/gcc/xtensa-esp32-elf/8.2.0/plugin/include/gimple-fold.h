...
extern tree gimple_fold_stmt_to_constant_1(
    gimple*, tree (*)(tree), tree (*)(tree) = no_follow_ssa_edges);
...
extern tree gimple_build(gimple_seq*, location_t, enum built_in_function, tree,
                         tree);
inline tree gimple_build(gimple_seq* seq, enum built_in_function fn, tree type,
                         tree arg0) {
...
extern tree gimple_simplify(enum tree_code, tree, tree, tree, tree, gimple_seq*,
                            tree (*)(tree));
extern tree gimple_simplify(enum built_in_function, tree, tree, gimple_seq*,
                            tree (*)(tree));
