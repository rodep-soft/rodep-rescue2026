...
struct __has_contiguous_iter<std::vector<_Tp, _Alloc>> : std::true_type {};
...
struct __is_contiguous_normal_iter<__gnu_cxx::__normal_iterator<_Tp, _Cont>>
...
inline __enable_if_contiguous_normal_iter<_FwdIter, _TraitsT> __compile_nfa(
...
template <typename _TraitsT, typename _FwdIter>
inline __disable_if_contiguous_normal_iter<_FwdIter, _TraitsT> __compile_nfa(
    _FwdIter __first, _FwdIter __last,
    const typename _TraitsT::locale_type& __loc,
    regex_constants::syntax_option_type __flags) {
...
struct _BracketMatcher {
   ...
   private:
    ...
    typedef typename std::conditional<
        _UseCache::value, std::bitset<_S_cache_size()>, _Dummy>::type _CacheT;
