...
extern simple_ipa_opt_pass* make_pass_ipa_chkp_early_produce_thunks(
    gcc::context* ctxt);
extern simple_ipa_opt_pass* make_pass_ipa_chkp_produce_thunks(
    gcc::context* ctxt);
...
extern gimple_opt_pass* make_pass_remove_cgraph_callee_edges(
    gcc::context* ctxt);
...
extern simple_ipa_opt_pass* make_pass_ipa_function_and_variable_visibility(
    gcc::context* ctxt);
...
extern simple_ipa_opt_pass* make_pass_chkp_instrumentation_passes(
    gcc::context* ctxt);
extern simple_ipa_opt_pass* make_pass_local_optimization_passes(
    gcc::context* ctxt);

extern ipa_opt_pass_d* make_pass_ipa_whole_program_visibility(
    gcc::context* ctxt);
extern simple_ipa_opt_pass* make_pass_ipa_increase_alignment(
    gcc::context* ctxt);
...
extern simple_ipa_opt_pass* make_pass_materialize_all_clones(
    gcc::context* ctxt);
...
extern rtl_opt_pass* make_pass_value_profile_transformations(
    gcc::context* ctxt);
