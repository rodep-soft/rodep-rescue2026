   ...
   public:
...
#endif
    {
        if (!__x.empty()) {
            ...
            this->_M_transfer(__position._M_const_cast(), __x.begin(),
                              __x.end());
...
#endif
    {
        if (__first != __last) {
            ...
            this->_M_transfer(__position._M_const_cast(),
                              __first._M_const_cast(), __last._M_const_cast());
        }
    }
   ...
   protected:
    ...
    void _M_move_assign(list&& __x, false_type) {
        if (__x._M_get_Node_allocator() == this->_M_get_Node_allocator())
            ...
            _M_assign_dispatch(
                std::__make_move_if_noexcept_iterator(__x.begin()),
                std::__make_move_if_noexcept_iterator(__x.end()),
                __false_type{});
    }
#endif
