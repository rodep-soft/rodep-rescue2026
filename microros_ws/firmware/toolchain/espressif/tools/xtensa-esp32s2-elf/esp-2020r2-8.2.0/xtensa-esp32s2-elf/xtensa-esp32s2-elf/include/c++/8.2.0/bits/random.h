   ...
   public:
    ...
    _DInputType operator()() {
        return std::generate_canonical<
            _DInputType, std::numeric_limits<_DInputType>::digits, _Engine>(
            _M_g);
    }
   ...
   public:
    ...
    template <typename _Sseq,
              typename = typename std::enable_if<!std::is_same<
                  _Sseq, linear_congruential_engine>::value>::type>
...
class mersenne_twister_engine {
   ...
   public:
     ...
     * @param __q the seed sequence.
     */
    template <typename _Sseq, typename = typename std::enable_if<!std::is_same<
                                  _Sseq, mersenne_twister_engine>::value>::type>
...
class subtract_with_carry_engine {
   ...
   public:
    ...
    template <typename _Sseq,
              typename = typename std::enable_if<!std::is_same<
                  _Sseq, subtract_with_carry_engine>::value>::type>
   ...
   public:
    ...
    template <typename _Sseq,
              typename = typename std::enable_if<
                  !std::is_same<_Sseq, discard_block_engine>::value &&
...
class independent_bits_engine {
   ...
   public:
    ...
    template <typename _Sseq,
              typename = typename std::enable_if<
                  !std::is_same<_Sseq, independent_bits_engine>::value &&
                  !std::is_same<_Sseq, _RandomNumberEngine>::value>::type>
...
class shuffle_order_engine {
   ...
   public:
    ...
    template <typename _Sseq,
              typename = typename std::enable_if<
                  !std::is_same<_Sseq, shuffle_order_engine>::value &&
                  !std::is_same<_Sseq, _RandomNumberEngine>::value>::type>
...
class random_device {
   public:
    ...
    explicit random_device(const std::string& __token = "default") {
        _M_init(__token);
    }
...
class fisher_f_distribution {
   ...
   public:
    ...
    friend bool operator==(const fisher_f_distribution& __d1,
        ...
        return (__d1._M_param == __d2._M_param &&
                __d1._M_gd_x == __d2._M_gd_x && __d1._M_gd_y == __d2._M_gd_y);
    }
...
class bernoulli_distribution {
   ...
   public:
    ...
    result_type operator()(_UniformRandomNumberGenerator& __urng,
                           const param_type& __p) {
        __detail::_Adaptor<_UniformRandomNumberGenerator, double> __aurng(
            __urng);
...
class binomial_distribution {
   ...
   public:
    ...
    // constructors and member function
    explicit binomial_distribution(_IntType __t = _IntType(1), double __p = 0.5)
