...
#define _GLIBCXX_CLASS_REQUIRES4(_type_var1, _type_var2, _type_var3,                     \
    ...
    struct _concept_checking##_type_var1##_type_var2##_type_var3##_type_var4##           \
        _concept {};                                                                     \
...
struct _BinaryPredicateConcept {
    void __constraints() {
        __aux_require_boolean_expr(
            __f(__a, __b));  // require op() returning bool
    }
    _Func __f;
    _First __a;
    _Second __b;
...
struct _Mutable_ReversibleContainerConcept {
    ...
    void __constraints() {
        __function_requires<
            _ReversibleContainerConcept<_ReversibleContainer> >();
        __function_requires<
            _Mutable_ForwardContainerConcept<_ReversibleContainer> >();
        __function_requires<
            _Mutable_BidirectionalIteratorConcept<_Iterator> >();
        __function_requires<
