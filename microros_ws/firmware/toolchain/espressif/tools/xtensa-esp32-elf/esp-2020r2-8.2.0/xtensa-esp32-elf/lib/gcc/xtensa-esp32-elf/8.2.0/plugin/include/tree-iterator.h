...
static inline bool tsi_end_p(tree_stmt_iterator i) { return i.ptr == NULL; }
...
static inline void tsi_prev(tree_stmt_iterator* i) { i->ptr = i->ptr->prev; }

static inline tree* tsi_stmt_ptr(tree_stmt_iterator i) { return &i.ptr->stmt; }
