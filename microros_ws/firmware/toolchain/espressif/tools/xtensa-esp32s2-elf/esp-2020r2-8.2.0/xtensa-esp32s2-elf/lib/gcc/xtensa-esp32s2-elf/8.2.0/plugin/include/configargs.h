...
static const char configuration_arguments[] =
    ...
    "--with-local-prefix=/builds/idf/crosstool-NG/builds/xtensa-esp32s2-elf/"
    "xtensa-esp32s2-elf "
    "--with-headers=/builds/idf/crosstool-NG/builds/xtensa-esp32s2-elf/"
    "xtensa-esp32s2-elf/include --with-newlib --enable-threads=no "
    "--disable-shared --with-pkgversion='crosstool-NG esp-2020r2' "
