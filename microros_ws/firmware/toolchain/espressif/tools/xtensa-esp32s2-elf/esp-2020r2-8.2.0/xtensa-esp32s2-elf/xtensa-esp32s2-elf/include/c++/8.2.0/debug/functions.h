...
inline bool __check_singular(const _Iterator& __x) {
    return __check_singular_aux(std::__addressof(__x));
}

/** Non-NULL pointers are nonsingular. */
template <typename _Tp>
inline bool __check_singular(const _Tp* __ptr) {
    return __ptr == 0;
}
...
template <typename _Iterator>
inline bool __check_dereferenceable(const _Iterator&) {
    return true;
}

/** Non-NULL pointers are dereferenceable. */
template <typename _Tp>
inline bool __check_dereferenceable(const _Tp* __ptr) {
    return __ptr;
}
...
inline bool __foreign_iterator_aux(
    const _Safe_iterator<_Iterator, _Sequence>& __it, _InputIterator __other,
    _InputIterator __other_end, std::__false_type) {
...
inline const _CharT* __check_string(const _CharT* __s, const _Integer& __n
                                    __attribute__((__unused__))) {
...
inline bool __check_sorted_aux(_ForwardIterator __first,
...
template <typename _InputIterator>
inline bool __check_sorted(const _InputIterator& __first,
                           const _InputIterator& __last) {
...
inline bool __check_sorted_set(const _InputIterator1& __first,
    ...
    typedef
        typename std::__are_same<_ValueType1, _ValueType2>::__type _SameType;
...
inline bool __check_partitioned_lower(_ForwardIterator __first,
                                      _ForwardIterator __last,
                                      const _Tp& __value) {
...
template <typename _ForwardIterator, typename _Tp>
inline bool __check_partitioned_upper(_ForwardIterator __first,
                                      _ForwardIterator __last,
                                      const _Tp& __value) {
...
struct _Irreflexive_checker {
    ...
    template <typename... _Args>
    static bool _S_is_valid_pred(_Args...) {
        return true;
    }
};

template <typename _Iterator>
inline bool __is_irreflexive(_Iterator __it) {
