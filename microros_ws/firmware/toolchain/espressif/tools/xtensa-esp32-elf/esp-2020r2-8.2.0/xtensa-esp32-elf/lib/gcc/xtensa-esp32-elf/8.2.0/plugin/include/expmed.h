...
static inline bool* expmed_op_cheap_ptr(struct expmed_op_cheap* eoc, bool speed,
                                        machine_mode mode) {
...
static inline int* expmed_op_cost_ptr(struct expmed_op_costs* costs, bool speed,
                                      machine_mode mode) {
    int idx = expmed_mode_index(mode);
...
static inline void set_sdiv_pow2_cheap(bool speed, machine_mode mode,
                                       bool cheap_p) {
...
static inline void set_smod_pow2_cheap(bool speed, machine_mode mode,
                                       bool cheap) {
...
static inline int zero_cost(bool speed) { return *zero_cost_ptr(speed); }
...
static inline int* shift_cost_ptr(bool speed, machine_mode mode, int bits) {
    return expmed_op_cost_ptr(&this_target_expmed->x_shift_cost[bits], speed,
                              mode);
}

/* Set the COST of doing a shift in MODE by BITS when optimizing for SPEED.  */

static inline void set_shift_cost(bool speed, machine_mode mode, int bits,
                                  int cost) {
...
static inline int* shiftadd_cost_ptr(bool speed, machine_mode mode, int bits) {
    return expmed_op_cost_ptr(&this_target_expmed->x_shiftadd_cost[bits], speed,
                              mode);
}
...
static inline void set_shiftadd_cost(bool speed, machine_mode mode, int bits,
                                     int cost) {
...
static inline void set_shiftsub0_cost(bool speed, machine_mode mode, int bits,
                                      int cost) {
...
static inline void set_shiftsub1_cost(bool speed, machine_mode mode, int bits,
                                      int cost) {
...
static inline void set_mul_highpart_cost(bool speed, machine_mode mode,
                                         int cost) {
...
static inline int* convert_cost_ptr(machine_mode to_mode,
...
static inline void set_convert_cost(machine_mode to_mode,
                                    machine_mode from_mode, bool speed,
                                    int cost) {
...
static inline int convert_cost(machine_mode to_mode, machine_mode from_mode,
                               bool speed) {
...
extern void store_bit_field(rtx, poly_uint64, poly_uint64, poly_uint64,
                            poly_uint64, machine_mode, rtx, bool);
