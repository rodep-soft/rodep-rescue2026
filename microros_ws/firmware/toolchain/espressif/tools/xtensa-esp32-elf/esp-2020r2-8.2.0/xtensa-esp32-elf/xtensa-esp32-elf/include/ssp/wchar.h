...
#define __ssp_bos_wicheck3_restrict(fun)                                \
    __ssp_redirect_wc(wchar_t*, fun,                                    \
                      (wchar_t* __restrict __buf,                       \
                       const wchar_t* __restrict __src, size_t __wlen), \
                      (__buf, __src, __wlen), 1, __ssp_bos0)
                    ...
                    __ssp_bos_wicheck3(wmemmove)
                        ...
                        __ssp_bos_wicheck3_restrict(wmempcpy)
                            ...
                            __ssp_redirect_wc(wchar_t*, wmemset,
                                              (wchar_t * __buf, wchar_t __src,
                                               size_t __wlen),
                                              (__buf, __src, __wlen), 1,
                                              __ssp_bos0)

                                __ssp_decl(size_t, wcrtomb,
                                           (char* __buf, wchar_t __src,
                                            mbstate_t* __ps)) {
...
__ssp_redirect_wc(size_t, mbsrtowcs,
                  (wchar_t * __buf, const char** __src, size_t __wlen,
                   mbstate_t* __ps),
    ...
    __ssp_redirect_raw(size_t, wcsrtombs,
        ...
        __ssp_redirect_wc(size_t, mbsnrtowcs,
                          ...
                          (__buf, __src, __nms, __wlen, __ps), __buf != NULL,
                          __ssp_bos)

            __ssp_redirect_raw(size_t, wcsnrtombs,
                               (char* __buf, const wchar_t** __src,
                                size_t __nwc, size_t __len, mbstate_t* __ps),
                               (__buf, __src, __nwc, __len, __ps),
                               __buf != NULL, __ssp_bos)
#endif
...
#if __GNU_VISIBLE
__ssp_decl(wchar_t*, fgetws_unlocked,
           (wchar_t * __buf, int __wlen, FILE* __fp)) {
    if (__wlen > 0)
        __ssp_check(__buf, (size_t)__wlen * sizeof(wchar_t), __ssp_bos);
