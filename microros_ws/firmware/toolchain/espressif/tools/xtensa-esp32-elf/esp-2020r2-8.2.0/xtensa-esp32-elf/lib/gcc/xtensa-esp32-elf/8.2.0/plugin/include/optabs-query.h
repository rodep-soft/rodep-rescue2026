...
static inline enum insn_code get_vec_cmp_icode(machine_mode vmode,
...
static inline enum insn_code get_vec_cmp_eq_icode(machine_mode vmode,
                                                  machine_mode mask_mode) {
...
inline enum insn_code get_vcond_icode(machine_mode vmode, machine_mode cmode,
                                      bool uns) {
...
static inline enum insn_code get_vcond_mask_icode(machine_mode vmode,
                                                  machine_mode mmode) {
...
static inline enum insn_code get_vcond_eq_icode(machine_mode vmode,
                                                machine_mode cmode) {
...
template <typename T>
inline enum insn_code find_widening_optab_handler_and_mode(optab op,
                                                           const T& to_mode,
                                                           const T& from_mode,
                                                           T* found_mode) {
    machine_mode tmp;
    ...
    if (icode != CODE_FOR_nothing && found_mode) *found_mode = as_a<T>(tmp);
    return icode;
}
