...
class ov_tree_node_const_it_ {
   protected:
    ...
    typedef
        typename _Alloc::template rebind<Metadata_Type>::other::const_pointer
...
class ov_tree_node_it_ : public PB_DS_OV_TREE_CONST_NODE_ITERATOR_C_DEC {
   ...
   public:
    ...
    typedef typename _Alloc::template rebind<
        typename remove_const<Value_Type>::type>::other::pointer
        const_reference;
    ...
    inline ov_tree_node_it_ get_r_child() const {
        ...
        return (
            this_type(base_type::mid_pointer(base_type::m_p_value + 1,
                                             base_type::m_p_end_value),
