...
class basic_regex {
   public:
     ...
     * regex_error is thrown, *this remains unchanged.
     */
    basic_regex& assign(const _Ch_type* __p, std::size_t __len,
                        flag_type __flags) {
...
class match_results : private std::vector<sub_match<_Bi_iter>, _Alloc> {
   ...
   public:
     ...
     */
    explicit match_results(const _Alloc& __a = _Alloc()) : _Base_type(__a) {}
    ...
    size_type max_size() const { return _Base_type::max_size(); }
     ...
     */
    const_iterator begin() const { return _Base_type::begin(); }
     ...
     */
    const_iterator end() const { return _Base_type::end() - (empty() ? 0 : 3); }
     ...
     */
    allocator_type get_allocator() const { return _Base_type::get_allocator(); }
   ...
   private:
    ...
    void _M_resize(unsigned int __size) { _Base_type::resize(__size + 3); }
...
class regex_iterator {
   public:
     ...
     */
    const value_type& operator*() const { return _M_match; }
