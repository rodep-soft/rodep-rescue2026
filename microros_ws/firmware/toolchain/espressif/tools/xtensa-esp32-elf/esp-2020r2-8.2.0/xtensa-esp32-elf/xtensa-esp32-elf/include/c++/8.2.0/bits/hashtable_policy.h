...
inline typename std::iterator_traits<_Iterator>::difference_type __distance_fw(
...
struct _Rehash_base<_Key, _Value, _Alloc, _ExtractKey, _Equal, _H1, _H2, _Hash,
                    _RehashPolicy, _Traits, std::false_type> {};
...
template <typename _Key, typename _Value, typename _Alloc, typename _ExtractKey,
          ...
          typename _RehashPolicy, typename _Traits>
struct _Rehash_base<_Key, _Value, _Alloc, _ExtractKey, _Equal, _H1, _H2, _Hash,
                    _RehashPolicy, _Traits, std::true_type> {
    using __hashtable = _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
                                   _H1, _H2, _Hash, _RehashPolicy, _Traits>;
...
struct _Hash_code_base<_Key, _Value, _ExtractKey, _H1, _H2,
   ...
   protected:
    ...
    __hash_code _M_hash_code(const _Key& __k) const { return _M_h1()(__k); }
...
/// local iterators
template <typename _Key, typename _Value, typename _ExtractKey, typename _H1,
          typename _H2, typename _Hash, bool __constant_iterators, bool __cache>
struct _Local_iterator : public _Local_iterator_base<_Key, _Value, _ExtractKey,
...
struct _Hashtable_base
   ...
   protected:
    ...
    bool _M_equals(const _Key& __k, __hash_code __c, __node_type* __n) const {
        return _EqualHelper::_S_equals(_M_eq(), this->_M_extract(), __k, __c,
                                       __n);
    }
...
template <typename _Uiterator>
bool _Equality_base::_S_is_permutation(_Uiterator __first1, _Uiterator __last1,
                                       _Uiterator __first2) {
    for (; __first1 != __last1; ++__first1, ++__first2)
        if (!(*__first1 == *__first2)) break;
    ...
    for (_Uiterator __it1 = __first1; __it1 != __last1; ++__it1) {
        ...
        while (__tmp != __it1 && !bool(*__tmp == *__it1)) ++__tmp;

        // We've seen this one before.
        if (__tmp != __it1) continue;

        std::ptrdiff_t __n2 = 0;
        for (__tmp = __first2; __tmp != __last2; ++__tmp)
            if (*__tmp == *__it1) ++__n2;

        if (!__n2) return false;
...
bool _Equality<_Key, _Value, _Alloc, _ExtractKey, _Equal, _H1, _H2, _Hash,
    ...
    for (auto __itx = __this->begin(); __itx != __this->end(); ++__itx) {
        ...
        if (__ity == __other.end() || !bool(*__ity == *__itx)) return false;
    }
    return true;
}
...
template <typename _NodeAlloc>
void _Hashtable_alloc<_NodeAlloc>::_M_deallocate_buckets(__bucket_type* __bkts,
                                                         std::size_t __n) {
