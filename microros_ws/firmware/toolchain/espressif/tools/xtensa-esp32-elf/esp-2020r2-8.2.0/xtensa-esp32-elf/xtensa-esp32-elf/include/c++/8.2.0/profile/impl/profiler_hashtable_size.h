...
inline __container_size_info* __trace_hashtable_size_construct(
    std::size_t __num) {
...
inline void __trace_hashtable_size_resize(__container_size_info* __obj_info,
                                          std::size_t __from,
                                          std::size_t __to) {
...
inline void __trace_hashtable_size_destruct(__container_size_info* __obj_info,
                                            std::size_t __num,
                                            std::size_t __inum) {
    if (!__obj_info) return;
