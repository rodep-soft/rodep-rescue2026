...
static inline SPARSESET_ELT_TYPE sparseset_size(sparseset s) { return s->size; }
...
static inline void sparseset_insert_bit(sparseset s, SPARSESET_ELT_TYPE e,
                                        SPARSESET_ELT_TYPE idx) {
    s->sparse[e] = idx;
    s->dense[idx] = e;
}
...
static inline void sparseset_set_bit(sparseset s, SPARSESET_ELT_TYPE e) {
    if (!sparseset_bit_p(s, e)) sparseset_insert_bit(s, e, s->members++);
}
