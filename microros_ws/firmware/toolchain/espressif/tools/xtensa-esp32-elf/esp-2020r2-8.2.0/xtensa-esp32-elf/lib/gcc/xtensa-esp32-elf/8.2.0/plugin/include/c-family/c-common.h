...
extern bool c_cpp_error(cpp_reader*, int, int, rich_location*, const char*,
...
/* In c-lex.c.  */
extern enum cpp_ttype conflict_marker_get_final_tok_kind(
...
static inline tree c_tree_chain_next(tree t) {
    ...
    if (CODE_CONTAINS_STRUCT(TREE_CODE(t), TS_COMMON)) return TREE_CHAIN(t);
    return NULL;
}
