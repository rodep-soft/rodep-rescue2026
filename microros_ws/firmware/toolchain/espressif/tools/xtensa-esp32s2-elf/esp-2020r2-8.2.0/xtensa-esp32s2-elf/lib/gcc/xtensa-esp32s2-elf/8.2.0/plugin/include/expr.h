...
static inline rtx emit_block_copy_via_libcall(rtx dst, rtx src, rtx size,
                                              bool tailcall = false) {
    return emit_block_op_via_libcall(BUILT_IN_MEMCPY, dst, src, size, tailcall);
}

static inline rtx emit_block_move_via_libcall(rtx dst, rtx src, rtx size,
                                              bool tailcall = false) {
    return emit_block_op_via_libcall(BUILT_IN_MEMMOVE, dst, src, size,
                                     tailcall);
}

static inline rtx emit_block_comp_via_libcall(rtx dst, rtx src, rtx size,
                                              bool tailcall = false) {
...
/* Return nonzero if it is desirable to store LEN bytes generated by
   ...
   of a const string.  */
extern int can_store_by_pieces(unsigned HOST_WIDE_INT, by_pieces_constfn, void*,
                               unsigned int, bool);
...
extern rtx expand_expr_real(tree, rtx, machine_mode, enum expand_modifier, rtx*,
                            bool);
