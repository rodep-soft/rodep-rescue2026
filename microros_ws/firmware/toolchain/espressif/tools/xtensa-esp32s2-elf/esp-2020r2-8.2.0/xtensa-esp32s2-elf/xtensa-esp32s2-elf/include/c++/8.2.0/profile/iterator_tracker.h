...
class __iterator_tracker {
   ...
   public:
    ...
    __iterator_tracker(const _Iterator& __i,
                       const _Sequence* __seq) _GLIBCXX_NOEXCEPT
        : _M_current(__i),
          _M_ds(__seq) {}
    ...
    _Iterator base() const _GLIBCXX_NOEXCEPT { return _M_current; }
    ...
    __iterator_tracker& operator=(const __iterator_tracker& __x)
        _GLIBCXX_NOEXCEPT {
        _M_current = __x._M_current;
        _M_ds = __x._M_ds;
        return *this;
    ...
    __iterator_tracker& operator+=(const difference_type& __n)
        _GLIBCXX_NOEXCEPT {
        _M_current += __n;
        return *this;
    }

    __iterator_tracker operator+(const difference_type& __n) const
        _GLIBCXX_NOEXCEPT {
        __iterator_tracker __tmp(*this);
        __tmp += __n;
        return __tmp;
...
template <typename _Iterator, typename _Sequence>
inline __iterator_tracker<_Iterator, _Sequence> operator+(
    typename __iterator_tracker<_Iterator, _Sequence>::difference_type __n,
