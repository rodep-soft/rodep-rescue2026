...
struct pat_trie_base {
    ...
    struct _Inode : public _Node_base<_ATraits, Metadata> {
       ...
       public:
        typedef
            typename _Alloc::template rebind<node_pointer>::other __rebind_np;
        ...
        struct const_iterator {
           ...
           protected:
            ...
            void assert_referencible() const {
                _GLIBCXX_DEBUG_ASSERT(m_p_p_cur != m_p_p_end &&
                                      *m_p_p_cur != 0);
            }
#endif
        };
        ...
        inline node_const_pointer get_child_node(a_const_iterator,
                                                 a_const_iterator,
                                                 a_const_pointer) const;
    ...
    class _CIter {
       ...
       protected:
        ...
        static node_pointer get_larger_sibling(node_pointer p_nd) {
            inode_pointer p_parent =
                static_cast<inode_pointer>(p_nd->m_p_parent);
...
#define PB_DS_PAT_TRIE_NODE_ITERATOR_C_DEC \
       ...
       private:
        a_const_iterator pref_begin() const {
            if (m_p_nd->m_type == leaf_node) {
                leaf_const_pointer lcp =
                    static_cast<leaf_const_pointer>(m_p_nd);
    ...
    class _Node_iter : public _Node_citer<Node, Leaf, Head, Inode, _CIterator,
                                          Iterator, _Alloc> {
       private:
        typedef _Node_citer<Node, Leaf, Head, Inode, _CIterator, Iterator,
                            _Alloc>
            base_type;
        typedef typename _Alloc::template rebind<Node> __rebind_n;
        typedef typename __rebind_n::other::pointer node_pointer;
