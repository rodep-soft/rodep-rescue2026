...
extern bool format_warning_va(const substring_loc& fmt_loc,
                              ...
                              const char* corrected_substring, int opt,
...
extern const char* get_source_location_for_substring(
    cpp_reader* pfile, string_concat_db* concats, location_t strloc,
    enum cpp_ttype type, int caret_idx, int start_idx, int end_idx,
    location_t* out_loc);
