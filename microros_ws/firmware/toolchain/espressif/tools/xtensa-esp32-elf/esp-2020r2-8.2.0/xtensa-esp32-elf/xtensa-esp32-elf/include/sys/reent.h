...
struct __sFILE {
    ...
    _READ_WRITE_RETURN_TYPE (*_read)(struct _reent*, void*, char*,
                                     _READ_WRITE_BUFSIZE_TYPE);
    _READ_WRITE_RETURN_TYPE (*_write)(struct _reent*, void*, const char*,
                                      _READ_WRITE_BUFSIZE_TYPE);
...
#define _REENT_INIT(var)                  \
    {0,                                   \
     ...
     _NULL,                               \
     _NULL,                               \
     _REENT_INIT_ATEXIT{_NULL, 0, _NULL}, \
     _NULL,                               \
     _NULL,                               \
     _NULL}
...
#define _REENT_CHECK_TM(var)                                                \
    _REENT_CHECK(                                                           \
        var, _localtime_buf, struct __tm*, sizeof *((var)->_localtime_buf), \
        /* nothing */)
...
#define _REENT_INIT(var)                                                      \
    {                                                                         \
        0, _REENT_STDIO_STREAM(&(var), 0), _REENT_STDIO_STREAM(&(var), 1),    \
            _REENT_STDIO_STREAM(&(var), 2), 0, "", 0, _NULL, 0, _NULL, _NULL, \
            0, _NULL, _NULL, 0, _NULL,                                        \
            {{0,                                                              \
              _NULL,                                                          \
              "",                                                             \
              {0, 0, 0, 0, 0, 0, 0, 0, 0},                                    \
