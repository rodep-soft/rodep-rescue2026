...
static inline unsigned int diagnostic_num_locations(
...
static inline expanded_location diagnostic_expand_location(
    const diagnostic_info* diagnostic, int which = 0) {
