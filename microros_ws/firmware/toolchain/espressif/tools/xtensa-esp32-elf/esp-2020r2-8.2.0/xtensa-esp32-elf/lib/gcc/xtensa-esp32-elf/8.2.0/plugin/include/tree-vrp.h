...
extern void extract_range_from_unary_expr(value_range* vr, enum tree_code code,
                                          tree type, value_range* vr0_,
                                          tree op0_type);
...
extern void register_edge_assert_for(tree, edge, enum tree_code, tree, tree,
                                     vec<assert_info>&);
...
extern void set_value_range(value_range*, enum value_range_type, tree, tree,
                            bitmap);
extern void set_and_canonicalize_value_range(value_range*,
                                             enum value_range_type, tree, tree,
                                             bitmap);
...
extern void extract_range_from_binary_expr_1(value_range*, enum tree_code, tree,
...
extern bool zero_nonzero_bits_from_vr(const tree, value_range*, wide_int*,
                                      wide_int*);
