...
static inline enum reg_class base_reg_class(
    machine_mode mode ATTRIBUTE_UNUSED, addr_space_t as ATTRIBUTE_UNUSED,
    ...
    if (index_code == REG) return MODE_BASE_REG_REG_CLASS(MACRO_MODE(mode));
#endif
...
static inline bool regno_ok_for_base_p(unsigned regno, machine_mode mode,
                                       addr_space_t as,
