...
class __hashfunc_info : public __object_info_base {
   public:
    ...
    void __destruct(std::size_t __chain, std::size_t __accesses,
                    std::size_t __hops) {
    ...
    std::string __advice() const { return "change hash function"; }
...
class __trace_hash_func
   ...
   public:
    ...
    void __destruct(__hashfunc_info* __obj_info, std::size_t __chain,
...
inline void __trace_hash_func_destruct(__hashfunc_info* __obj_info,
                                       std::size_t __chain,
                                       std::size_t __accesses,
                                       std::size_t __hops) {
    _GLIBCXX_PROFILE_DATA(_S_hash_func)
        ->__destruct(__obj_info, __chain, __accesses, __hops);
}
