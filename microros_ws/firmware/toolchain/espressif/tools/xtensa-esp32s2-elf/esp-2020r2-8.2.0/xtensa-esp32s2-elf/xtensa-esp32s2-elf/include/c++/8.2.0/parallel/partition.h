...
typename std::iterator_traits<_RAIter>::difference_type __parallel_partition(
    ...
    _GLIBCXX_VOLATILE _DifferenceType __left = 0, __right = __n - 1,
                                      __dist = __n, __leftover_left,
                                      __leftover_right, __leftnew, __rightnew;
...
#pragma omp barrier
            ...
            _DifferenceType __leftold = __left,
                            ...
                            __rightold = __right,
                            __rightnew =
                                __right + __leftover_right * __chunk_size;
...
void __parallel_nth_element(_RAIter __begin, _RAIter __nth, _RAIter __end,
    ...
    while (static_cast<_SequenceIndex>(__end - __begin) >= __minimum_length) {
        ...
        __split_pos1 =
            __begin + __parallel_partition(__begin, __end - 1, __pred,
                                           __get_max_threads());
        ...
        if ((__split_pos1 + 1 - __begin) < (__n >> 7) ||
            ...
            __gnu_parallel::__unary_negate<
                __gnu_parallel::__binder1st<_Compare, _ValueType, _ValueType,
                                            bool>,
                _ValueType>
