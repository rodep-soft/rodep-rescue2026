...
#define GCC_DRIVER_HOST_INITIALIZATION                                         \
    do {                                                                       \
        ...
        tooldir = concat(tooldir_base_prefix, spec_machine, dir_separator_str, \
                         NULL);                                                \
        ...
        add_prefix(&startfile_prefixes,                                        \
                   concat(archdir, "lib", dir_separator_str, NULL), "GCC",     \
                   PREFIX_PRIORITY_LAST, 0, 1);                                \
        add_prefix(&include_prefixes, archdir, "GCC", PREFIX_PRIORITY_LAST, 0, \
                   0);                                                         \
    } while (0)
