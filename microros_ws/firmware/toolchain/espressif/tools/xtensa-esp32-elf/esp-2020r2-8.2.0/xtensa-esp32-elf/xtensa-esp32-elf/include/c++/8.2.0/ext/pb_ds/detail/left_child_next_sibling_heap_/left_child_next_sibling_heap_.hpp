...
class left_child_next_sibling_heap : public Cmp_Fn {
   protected:
    typedef typename _Alloc::template rebind<left_child_next_sibling_heap_node_<
        Value_Type, Node_Metadata, _Alloc> >::other node_allocator;
   ...
   public:
    ...
    typedef left_child_next_sibling_heap_node_point_const_iterator_<node,
                                                                    _Alloc>
   ...
   private:
    ...
    static void trace_node_metadata(node_const_pointer,
