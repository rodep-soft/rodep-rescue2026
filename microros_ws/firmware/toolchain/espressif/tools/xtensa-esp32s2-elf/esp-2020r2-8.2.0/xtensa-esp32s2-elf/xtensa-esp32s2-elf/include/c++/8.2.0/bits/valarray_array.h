...
inline void* __valarray_get_memory(size_t __n) { return operator new(__n); }
...
#define _DEFINE_ARRAY_FUNCTION(_Op, _Name)                                     \
    ...
    void _Array_augmented_##_Name(_Array<_Tp> __a,                             \
    ...
    inline void _Array_augmented_##_Name(_Array<_Tp> __a, _Array<size_t> __i,  \
        ...
        for (size_t* __j = __i._M_data; __j < __i._M_data + __n; ++__j, ++__q) \
            __a._M_data[*__j] _Op## = *__q;                                    \
                                                                               ...
                                                                               \
    template <typename _Tp>                                                    \
    inline void _Array_augmented_##_Name(                                      \
    ...
    void _Array_augmented_##_Name(_Array<_Tp> __a, _Array<bool> __m,           \
        ...
        for (_Tp* __q = __b._M_data; __q < __b._M_data + __n;                  \
            ...
            *__p _Op## = *__q;                                                 \
                                                                               ...
                                                                               \
    template <typename _Tp>                                                    \
    void _Array_augmented_##_Name(_Array<_Tp> __a, size_t __n,                 \
