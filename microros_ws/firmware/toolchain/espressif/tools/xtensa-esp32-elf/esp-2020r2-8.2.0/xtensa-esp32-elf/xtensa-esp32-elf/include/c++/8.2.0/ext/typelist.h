...
#define _GLIBCXX_TYPELIST_CHAIN18(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, \
    ...
    __gnu_cxx::typelist::chain<                                                \
        X0, _GLIBCXX_TYPELIST_CHAIN17(X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, \
                                      X11, X12, X13, X14, X15, X16, X17)>
#define _GLIBCXX_TYPELIST_CHAIN19(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, \
                                  X11, X12, X13, X14, X15, X16, X17, X18)      \
    __gnu_cxx::typelist::chain<                                                \
        X0, _GLIBCXX_TYPELIST_CHAIN18(X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, \
                                      X11, X12, X13, X14, X15, X16, X17, X18)>
#define _GLIBCXX_TYPELIST_CHAIN20(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, \
                                  X11, X12, X13, X14, X15, X16, X17, X18, X19) \
    __gnu_cxx::typelist::chain<X0, _GLIBCXX_TYPELIST_CHAIN19(                  \
                                       X1, X2, X3, X4, X5, X6, X7, X8, X9,     \
