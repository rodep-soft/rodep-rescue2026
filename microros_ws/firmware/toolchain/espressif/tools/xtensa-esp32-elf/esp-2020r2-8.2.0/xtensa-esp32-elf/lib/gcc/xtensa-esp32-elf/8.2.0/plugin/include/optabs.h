...
static inline void create_expand_operand(struct expand_operand* op,
...
static inline void create_output_operand(struct expand_operand* op, rtx x,
                                         machine_mode mode) {
...
static inline void create_input_operand(struct expand_operand* op, rtx value,
                                        machine_mode mode) {
...
static inline void create_convert_operand_to(struct expand_operand* op,
                                             rtx value, machine_mode mode,
                                             bool unsigned_p) {
...
static inline void create_convert_operand_from(struct expand_operand* op,
                                               rtx value, machine_mode mode,
                                               bool unsigned_p) {
...
static inline void create_address_operand(struct expand_operand* op,
                                          rtx value) {
...
extern rtx expand_widen_pattern_expr(struct separate_ops*, rtx, rtx, rtx, rtx,
                                     int);
...
rtx emit_conditional_move(rtx, enum rtx_code, rtx, rtx, machine_mode, rtx, rtx,
                          machine_mode, int);
