...
static inline void dump_message_1(const char* message, const char* func,
                                  unsigned int line) {
...
static inline bool return_false_with_message_1(const char* message,
                                               const char* func,
                                               unsigned int line) {
    if (dump_file && (dump_flags & TDF_DETAILS))
...
static inline bool return_with_result(bool result, const char* func,
                                      unsigned int line) {
...
static inline bool return_different_stmts_1(gimple* s1, gimple* s2,
                                            const char* code, const char* func,
                                            unsigned int line) {
    if (dump_file && (dump_flags & TDF_DETAILS)) {
...
class func_checker {
   public:
    ...
    func_checker(tree source_func_decl, tree target_func_decl,
                 bool compare_polymorphic, bool ignore_labels = false,
