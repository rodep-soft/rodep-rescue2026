...
#define flag_chkp_first_field_has_own_bounds \
    global_options.x_flag_chkp_first_field_has_own_bounds
#endif
#ifdef GENERATOR_FILE
    extern int flag_chkp_flexible_struct_trailing_arrays;
#else
int x_flag_chkp_flexible_struct_trailing_arrays;
#define flag_chkp_flexible_struct_trailing_arrays \
    global_options.x_flag_chkp_flexible_struct_trailing_arrays
#endif
#ifdef GENERATOR_FILE
...
#define flag_chkp_instrument_marked_only \
    global_options.x_flag_chkp_instrument_marked_only
#endif
#ifdef GENERATOR_FILE
...
#define flag_chkp_narrow_to_innermost_arrray \
    global_options.x_flag_chkp_narrow_to_innermost_arrray
#endif
#ifdef GENERATOR_FILE
...
#define flag_chkp_zero_dynamic_size_as_infinite \
    global_options.x_flag_chkp_zero_dynamic_size_as_infinite
#endif
#ifdef GENERATOR_FILE
    extern int flag_chkp_use_fast_string_functions;
#else
int x_flag_chkp_use_fast_string_functions;
#define flag_chkp_use_fast_string_functions \
    global_options.x_flag_chkp_use_fast_string_functions
#endif
#ifdef GENERATOR_FILE
...
#define flag_chkp_use_nochk_string_functions \
    global_options.x_flag_chkp_use_nochk_string_functions
#endif
#ifdef GENERATOR_FILE
...
#define flag_chkp_use_static_const_bounds \
    global_options.x_flag_chkp_use_static_const_bounds
#endif
#ifdef GENERATOR_FILE
...
#define flag_chkp_zero_input_bounds_for_main \
    global_options.x_flag_chkp_zero_input_bounds_for_main
#endif
#ifdef GENERATOR_FILE
...
#define TARGET_ESP32_ALWAYS_MEMBARRIER \
    ((target_flags & MASK_ESP32_ALWAYS_MEMBARRIER) != 0)
#define TARGET_ESP32_ALWAYS_MEMBARRIER_P(target_flags) \
    (((target_flags) & MASK_ESP32_ALWAYS_MEMBARRIER) != 0)
#define TARGET_AUTO_LITPOOLS ((target_flags & MASK_AUTO_LITPOOLS) != 0)
#define TARGET_AUTO_LITPOOLS_P(target_flags) \
    (((target_flags) & MASK_AUTO_LITPOOLS) != 0)
#define TARGET_CONST16 ((target_flags & MASK_CONST16) != 0)
#define TARGET_CONST16_P(target_flags) (((target_flags) & MASK_CONST16) != 0)
#define TARGET_ESP32_PSRAM_FIX_ENA \
    ((target_flags & MASK_ESP32_PSRAM_FIX_ENA) != 0)
#define TARGET_ESP32_PSRAM_FIX_ENA_P(target_flags) \
    (((target_flags) & MASK_ESP32_PSRAM_FIX_ENA) != 0)
#define TARGET_FORCE_NO_PIC ((target_flags & MASK_FORCE_NO_PIC) != 0)
#define TARGET_FORCE_NO_PIC_P(target_flags) \
    (((target_flags) & MASK_FORCE_NO_PIC) != 0)
#define TARGET_SERIALIZE_VOLATILE \
    ((target_flags & MASK_SERIALIZE_VOLATILE) != 0)
#define TARGET_SERIALIZE_VOLATILE_P(target_flags) \
    (((target_flags) & MASK_SERIALIZE_VOLATILE) != 0)
...
enum opt_code {
    ...
    OPT_Waggressive_loop_optimizations =
        153,                            /* -Waggressive-loop-optimizations */
    ...
    OPT_Wbuiltin_declaration_mismatch =
        174,                                /* -Wbuiltin-declaration-mismatch */
    ...
    OPT_Wvector_operation_performance =
        446,                          /* -Wvector-operation-performance */
    ...
    OPT_Wzero_as_null_pointer_constant =
        453,                        /* -Wzero-as-null-pointer-constant */
    ...
    OPT_faggressive_function_elimination =
        484, /* -faggressive-function-elimination */
    OPT_faggressive_loop_optimizations =
        485,                             /* -faggressive-loop-optimizations */
    ...
    OPT_fallow_parameterless_variadic_functions =
        500, /* -fallow-parameterless-variadic-functions */
    ...
    OPT_fbranch_target_load_optimize2 =
        521,                               /* -fbranch-target-load-optimize2 */
    ...
    OPT_fchkp_first_field_has_own_bounds =
        544, /* -fchkp-first-field-has-own-bounds */
    OPT_fchkp_flexible_struct_trailing_arrays =
        545, /* -fchkp-flexible-struct-trailing-arrays */
    ...
    OPT_fchkp_narrow_to_innermost_array =
        549,                      /* -fchkp-narrow-to-innermost-array */
    ...
    OPT_fdiagnostics_parseable_fixits =
        615,                               /* -fdiagnostics-parseable-fixits */
    ...
    OPT_fdiagnostics_show_template_tree =
        619,                            /* -fdiagnostics-show-template-tree */
    ...
    OPT_feliminate_unused_debug_symbols =
        645, /* -feliminate-unused-debug-symbols */
    OPT_feliminate_unused_debug_types =
        646,                                /* -feliminate-unused-debug-types */
    ...
    OPT_finstrument_functions_exclude_file_list_ =
        748, /* -finstrument-functions-exclude-file-list= */
    OPT_finstrument_functions_exclude_function_list_ =
        749, /* -finstrument-functions-exclude-function-list= */
    ...
    OPT_fisolate_erroneous_paths_attribute =
        776, /* -fisolate-erroneous-paths-attribute */
    OPT_fisolate_erroneous_paths_dereference =
        777,                       /* -fisolate-erroneous-paths-dereference */
    ...
    OPT_freorder_blocks_and_partition =
        927,                             /* -freorder-blocks-and-partition */
    ...
    OPT_fsanitize_undefined_trap_on_error =
        945,              /* -fsanitize-undefined-trap-on-error */
    OPT_fsanitize_ = 946, /* -fsanitize= */
    OPT_fsched_critical_path_heuristic =
        947,                              /* -fsched-critical-path-heuristic */
    ...
    OPT_fsel_sched_pipelining_outer_loops =
        972, /* -fsel-sched-pipelining-outer-loops */
    OPT_fsel_sched_reschedule_pipelined =
        973,                              /* -fsel-sched-reschedule-pipelined */
    ...
    OPT_ftree_loop_distribute_patterns =
        1060,                           /* -ftree-loop-distribute-patterns */
    ...
    OPT_ginternal_reset_location_views =
        1154,                            /* -ginternal-reset-location-views */
    OPT_gnat = 1155,                     /* -gnat */
    ...
    OPT_gvariable_location_views_incompat5 =
        1168,                     /* -gvariable-location-views=incompat5 */
    OPT_gvms = 1169,              /* -gvms */
    ...
    OPT_malways_memw = 1190,      /* -malways-memw */
    OPT_mauto_litpools = 1191,    /* -mauto-litpools */
    OPT_mconst16 = 1192,          /* -mconst16 */
    OPT_mfix_esp32_psram_cache_issue = 1193, /* -mfix-esp32-psram-cache-issue */
    OPT_mfix_esp32_psram_cache_strategy_ =
        1194,                            /* -mfix-esp32-psram-cache-strategy= */
    OPT_mforce_no_pic = 1195,            /* -mforce-no-pic */
    /* OPT_mfused_madd = 1196, */        /* -mfused-madd */
    OPT_mlongcalls = 1197,               /* -mlongcalls */
    OPT_mserialize_volatile = 1198,      /* -mserialize-volatile */
    OPT_mtarget_align = 1199,            /* -mtarget-align */
    OPT_mtext_section_literals = 1200,   /* -mtext-section-literals */
    OPT_n = 1201,                        /* -n */
    ...
    OPT_static_pie = 1252,                   /* -static-pie */
    ...
    OPT_std_c__2a = 1260,                    /* -std=c++2a */
    OPT_std_c__98 = 1261,                    /* -std=c++98 */
    OPT_std_c11 = 1262,                      /* -std=c11 */
    OPT_std_c17 = 1263,                      /* -std=c17 */
    /* OPT_std_c18 = 1264, */                /* -std=c18 */
    ...
    OPT_std_gnu__2a = 1283,                  /* -std=gnu++2a */
    OPT_std_gnu__98 = 1284,                  /* -std=gnu++98 */
    OPT_std_gnu11 = 1285,                    /* -std=gnu11 */
    OPT_std_gnu17 = 1286,                    /* -std=gnu17 */
    /* OPT_std_gnu18 = 1287, */              /* -std=gnu18 */
    ...
    /* OPT_std_iso9899_2017 = 1298, */       /* -std=iso9899:2017 */
    /* OPT_std_iso9899_2018 = 1299, */       /* -std=iso9899:2018 */
    OPT_std_legacy = 1300,                   /* -std=legacy */
    OPT_symbolic = 1301,                     /* -symbolic */
    OPT_t = 1302,                            /* -t */
    OPT_time = 1303,                         /* -time */
    OPT_time_ = 1304,                        /* -time= */
